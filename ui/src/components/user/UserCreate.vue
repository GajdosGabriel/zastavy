            ...
            <div class="page-body col-span-12">
                ...
                <form @submit.prevent="saveUser" class="rounded bg-white px-8 pt-6 pb-8 shadow-md">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <!-- Status — len super-admin; ostatní vytvárajú účet ako draft na overenie emailom -->
                        <div v-if="canManageRoles && getStatuses.length">
                            <label class="mb-2 block text-sm font-bold text-gray-700">Status <RequiredMark /></label>
                            <select
                                v-model="store.user.status"
                                required
                                class="w-full rounded border border-gray-300 px-3 py-2 focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-400"
                            >
                            ...
                            <p v-else class="mt-1 text-xs text-gray-500">Draft = účet čaká na overenie emailu.</p>
                        </div>
