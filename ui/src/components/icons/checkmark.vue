<template>
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0"
        viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" class="h-5 w-5 mr-1 cursor-pointer"
        fill="none">
        <g>
            <switch>
                <g>
                    <g fill="#02bc7d">
                        <path
                            ...
                            fill="#02bc7d" opacity="1" data-original="#02bc7d" class=""></path>
                        <path
